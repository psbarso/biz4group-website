	...
	<div class="container">
		<div class="row">
			...
			<div class="interactive-prototype-detail-content">
					<h5>An Enterprise Blockchain</h5>
					<p>An enterprise blockchain designed specifically for the global legal industry, facilitates URLs that can be used by various companies for demo options.</p>
			  ...
			  <div class="ip-desktop-img" id="ip-click-demo">
					<img src="images/integra-desktop-img.png" alt="">
 ...
 <div class="detail-listing-prototype">
	<div class="container-fluid">
		<div class="row">
			...
			<img src="images/clickable-prototype4.jpg" alt="">
			<div class="prototype-view-details">
			<a href="https://www.biz4group.com/racooda-interactive-prototype" target="_blank">View</a>
			</div>
			</div>
			<p>eCommerce solutions to connect athletes globally</p>
			</div>
		</div>
		<div class="col-md-3 col-sm-6">
			<div class="interactive-prototype">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content abt-content">
      ...
      <div class="modal-body">
		<div class="">
		<iframe width="100%" scrolling="yes" src="https://xd.adobe.com/embed/7363dbe1-4fa6-4330-528f-e3b283a89120-0552/" frameborder="0" allowfullscreen></iframe>
		</div>
		<h5>An Enterprise Blockchain</h5>
		<p>An enterprise blockchain designed specifically for the global legal industry, facilitates URLs that can be used by various companies for demo options.</p>
      </div>
