...
$errors = '';
$to = 'hr@biz4group.com,sakshi@biz4group.com';
$subject='Resume';
//print_r ($_POST);
if(empty($_POST['name'])  ||
   empty($_POST['phoneno']) ||
...
<table width="600" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #E3E3E3;" align="center">
  ...
  <td align="left" valign="top" style="font-family: Arial, Helvetica, sans-serif; font-size:13px;  color:#3e3e3e; background-color:#f7f7f7;">'.$experience.'</td>
  </tr>
  <tr>
...
$cc = 'hr@biz4group.com,sakshi@biz4group.com';
$resumefile='upload/'.$_FILES["resumefile"]["name"];
$extArr = explode(".",$_FILES["resumefile"]["name"]);
$ext = end($extArr);
$allowed = array('docx','doc','pdf');
if( !in_array( $ext, $allowed ) ) { echo '<script>
alert("Invalid file type.")
window.location.href = "https://www.biz4group.com/career";
</script>';}
