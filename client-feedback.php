			...
			<div class="row">
				...
				<div class="col-md-6 col-sm-6">
					<div class="client-feedback-logo">
						<a href="#">
							<img src="https://www.biz4group.com/images/logo.png" alt="">
						</a>	
					</div>
				</div>
			</div>
				...
				<form id="send-contact-form" method="post" enctype="multipart/form-data">
					<div class="row">
						...
						<div class="col-md-5">
							...
							<div class="form-group">
								<input type="tel" class="form-control" placeholder="Enter your contact number*" name="number" id="phone"  maxlength='13' pattern="[1-9]{1}[0-9]{13}" required > 
							</div>
							<div class="form-group">
								<div class="client-feedback-fileinput">
									<p>Please attach your professional headshot here as usually after the successful completion of the projects we post the feedback of our clients on our website.</p>
									<div class="client-feedback-fileinput-box">
									
										<div class="client-feedback-drop">
											<div class="uploadFile">
												<input type="file" id="attach_file" class="attachOne" name="attach_file_drop" value="" placeholder="">
												<span class="addfile"><p><img src="https://www.biz4group.com/images/drop-img.png"/></p><label class="custom-file-label" for="inputGroupFile02">Drag and drop</label></span>
												<p style="color: red; margin-top: 10px; text-align: center;" id="attach_file_drop_error"></p>
											</div>
										</div>
										
										<div class="client-feedback-orline">
											<span>or</span>
											<div class="client-feedback-orborder">
											</div>
										</div>
										
										<div class="client-feedback-uploadFile">
											<div class="uploadFile">
													<input type="file" id="attach_file" class="attachTwo" name="attach_file" value="" placeholder="">
													<span class="addfile"><label class="custom-file-label-two" for="inputGroupFile02">Browse files</label></span>
											</div>
										</div>
							...
							<div class="client-feedback-rightform">
								...
								<div class="feedback-starbox">
									<div class="row">
										<div class="col-lg-7 col-md-6">
											<div class="feedback-starbox-heading">
												<h5>Does your contact person work as a trusted advisor?</h5>
											</div>
										</div>
										<div class="col-lg-5 col-md-6">
											<div class="feedback-stars">
								...
								<div class="feedback-starbox">
									<div class="row">
										<div class="col-lg-7 col-md-6">
											<div class="feedback-starbox-heading">
												<h5>Are you receiving timely delivery?</h5>
											</div>
										</div>
										<div class="col-lg-5 col-md-6">
											<div class="feedback-stars">
								...
								<div class="feedback-starbox">
									<div class="row">
										<div class="col-lg-7 col-md-6">
											<div class="feedback-starbox-heading">
												<h5>Do we have required technical expertise to work on your dream project?</h5>
											</div>
										</div>
										<div class="col-lg-5 col-md-6">
											<div class="feedback-stars">
								...
								<div class="feedback-starbox">
									...
									<div class="form-group">
										<textarea class="feedback-textarea form-control" id="id_quality" name="improvements"></textarea>
									</div>
								</div>
