	...
	<div class="container">
		<div class="row">
			...
			<div class="interactive-prototype-detail-content">
					<h5>eCommerce App For On-demand Fuel Delivery</h5>
					<p>Fuelit app targets modern customers for the delivery of fuel at their doorstep. The Fuelit platform acts as a bridge between fuel providers and the customers for scheduled and emergency fuel deliveries.</p>
			  ...
			  <div class="ip-desktop-img" id="ip-click-demo">
					<img src="images/interactive-prototype-fuelit-2.png" alt="">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content abt-content">
      ...
      <div class="modal-body">
		<div class="">
		<iframe width="100%" src="https://xd.adobe.com/embed/1996f6a4-b9cd-4f91-a76f-ba3771af2035-4cc5/" frameborder="0" allowfullscreen></iframe>
		</div>
		<h5>eCommerce App For On-Demand Fuel Delivery</h5>
		<p>Fuelit app targets modern customers for the delivery of fuel at their doorstep. The Fuelit platform acts as a bridge between fuel providers and the customers for scheduled and emergency fuel deliveries.</p>
		</div>
