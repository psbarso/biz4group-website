	...
	<div class="container">
		<div class="row">
			...
			<div class="interactive-prototype-detail-content">
					<h5>eCommerce Platforms For Medical Products</h5>
					<p>Gold leaf was designed as a cannabis website for dispensaries. It offers various kinds of products within the platform. It also offers daily deals to the users which brings it in a better spot by making it one of the leading eCommerce platforms for medical products.</p>
			  ...
			  <div class="ip-desktop-img" id="ip-click-demo">
					<img src="images/gold-leaf-inner.png" alt="">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content abt-content">
      ...
      <div class="modal-body">
		<div class="">
		<iframe width="100%" src="https://xd.adobe.com/embed/e41cbccc-2734-4f65-8523-c496c3512f98-b14f/" frameborder="0" allowfullscreen></iframe>
		</div>
		<h5>eCommerce Platforms For Medical Products</h5>
		<p>Gold leaf was designed as a cannabis website for dispensaries. It offers various kinds of products within the platform. It also offers daily deals to the users which brings it in a better spot by making it one of the leading eCommerce platforms for medical products.</p>
		</div>
