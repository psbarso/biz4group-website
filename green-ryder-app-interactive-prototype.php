	...
	<div class="container">
		<div class="row">
			...
			<div class="interactive-prototype-detail-content">
					<h5>eCommerce Platform For Medicine And Healthcare Products</h5>
					<p>A consolidated eCommerce application that offers online consulting services as well as delivery of drugs and other healthcare necessities to your home. Additionally, Green Ryder allows customers to order prescription medications from the comfort of their homes.</p>
			  ...
			  <div class="ip-desktop-img" id="ip-click-demo">
					<img src="images/interactive-prototype-green-ryder-app-2.png" alt="">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content abt-content">
      ...
      <div class="modal-body">
		<div class="">
		<iframe width="100%" src="https://xd.adobe.com/embed/e9e561e7-f06f-4ed4-8e71-577a8c2e6411-bcb6/" frameborder="0" allowfullscreen></iframe>
		</div>
		<h5>eCommerce Platform For Medicine And Healthcare Products</h5>
		<p>A unified eCommerce platform that brings medicine and healthcare essentials to your doorstep along with online consultation services. Moreover, the customers can also order prescription medicines from the convenience of their homes using Green Ryder.</p>
		</div>
    </div>
  </div>
</div>
