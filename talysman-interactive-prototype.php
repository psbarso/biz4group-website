	...
	<div class="container">
		<div class="row">
			...
			<div class="interactive-prototype-detail-content">
				<h5>A Simplistic Website For Users To Purchase Lottery Tickets And Win Rewards</h5>
				<p>A simple yet highly-functional platform where users can register themselves and buy the lottery tickets and win various prices. In case the user doesn’t win, he/she can claim rewards in form of a coupon or reward point.</p>
			  ...
			  <div class="ip-desktop-img" id="ip-click-demo">
					<img src="images/talysman-inner.png" alt="">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content abt-content">
      ...
      <div class="modal-body">
		<div class="">
		<iframe width="100%" src="https://xd.adobe.com/embed/319fd428-8d0a-4707-8150-211d02cbbb8d-64cc/" frameborder="0" allowfullscreen></iframe>
		</div>
		<h5>A Simplistic Website For Users To Purchase Lottery Tickets And Win Rewards</h5>
		<p>A simple yet highly-functional platform where users can register themselves and buy the lottery tickets and win various prices. In case the user doesn’t win, he/she can claim rewards in form of a coupon or reward point.</p>
		</div>
