	...
	<div class="container">
		<div class="row">
			...
			<div class="interactive-prototype-detail-content">
					<h5>eCommerce Web App</h5>
					<p>It focuses on finding an early solution to end the current pandemic situation by discovering a vaccine and selling it all round the locations through online orders. </p>
			  ...
			  <div class="ip-desktop-img" id="ip-click-demo">
					<img src="images/covix-desktop-img.png" alt="">
 ...
 <div class="detail-listing-prototype">
	<div class="container-fluid">
		...
		<div class="col-md-3 col-sm-6">
			<div class="interactive-prototype">
			<div class="interactive-prototype-img">
			<img src="images/clickable-prototype7.jpg" alt="">
			<div class="prototype-view-details">
			<a href="https://www.biz4group.com/ipause-interactive-prototype" target="_blank">View</a>
			</div>
			</div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content abt-content">
      ...
      <div class="modal-body">
		<div class="">
		<iframe width="100%" scrolling="yes" src="https://xd.adobe.com/embed/770be1bb-d6ec-4b9e-46e4-bddcf985cfa3-013a/" frameborder="0" allowfullscreen></iframe>
		</div>
		<h5>eCommerce Web App</h5>
		<p>It focuses on finding an early solution to end the current pandemic situation by discovering a vaccine and selling it all round the locations through online orders. </p>
		</div>
