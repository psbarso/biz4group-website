	...
	<div class="container">
		<div class="row">
			...
			<div class="interactive-prototype-detail-content">
					<h5>A Subscription Based eCommerce Platform For Products And Services</h5>
					<p>Developed a feature-rich eCommerce platform with specific subscription packages to best suit the vendor’s business requirements. It comes with a dedicated dashboard to let users manage their sales and orders on a weekly, monthly or annual basis.</p>
			  ...
			  <div class="ip-desktop-img" id="ip-click-demo">
					<img src="images/interactive-prototype-subsciety-2.png" alt="">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content abt-content">
      ...
      <div class="modal-body">
		<div class="">
		<iframe width="100%" src="https://xd.adobe.com/embed/bfd50b04-abf6-4749-a033-f810ae4f790c-ea86/" frameborder="0" allowfullscreen></iframe>
		</div>
		<h5>A Subscription Based eCommerce Platform For Products And Services</h5>
		<p>Developed a feature-rich eCommerce platform with specific subscription packages to best suit the vendor’s business requirements. It comes with a dedicated dashboard to let users manage their sales and orders on a weekly, monthly or annual basis.</p>
		</div>
