...
<style>
	...
	background: transparent linear-gradient(180deg, #FB6D63 0%, #F24C7C 100%) 0% 0% no-repeat padding-box;
	 }
	.theme-border{
	border:2px solid #F83459 ;
	background: #FFFFFF;
    border-radius: 20px;
	padding:15px;
	}
	...
	.portfolio-banner{
	background-image: url("https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/amour/glowapp-banner-new.webp");
	}
	.testomonial-outer{
	border: 10px solid #F83459  ;}	
	div#owl-demo-portfolio .owl-dots{
	display:none;}

	.portfolio-banner .banner-product-img {
    	max-width: 550px;
    	margin-top: 40px;
	}
...
<div class="app-portfolio-page">
	 ...
	 <img class="banner-product-img" src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/amour/glow-hero.webp" alt="glow-hero" width="640" height="320" loading="lazy"/>
	 
	 </div>
	 <div class="col-md-4 col-sm-12 center-al">
	 	<h1 class="horizontal-line bg-white banner"><b>PORTFOLIO</b></h1>
		<h2>Innovative Dating App<br/> To Find Your<br/> True Soulmate</h2>
		<div class="apphero-outer">
			<a class="apphero-link" href="https://apps.apple.com/in/app/amour-dating-app/id1620545838" target="_blank"><img src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/apple-store.webp" alt="apple-store" width="640" height="320" loading="lazy"></a>
			<a class="apphero-link" href="https://play.google.com/store/apps/details?id=com.amourdating.app" target="_blank"><img src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/amour/android-store.webp" alt="android-store" width="640" height="320" loading="lazy"></a>
		</div>
	 </div>
	 </div>
	 </div>
		...
		<div class="container">
			...
			<h2 class="heading-section margin-b-3 text-center">OUR SMART, EFFICIENT & PRODUCTIVE APPROACH</h2>
				...
				<div class="col-md-5 col-lg-5 col-sm-12 margin-b-3">
					<div class="challenge-card">
						<div class="challenge-img">
							<img class="fix-img" src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/amour/glowapp-challenge-new.webp" alt="challenge-new" width="640" height="320" loading="lazy"/>
						</div>
						<div class="challenge-left">
							...
							<div class="challenge-content">
								<p>
									Dating apps have become highly popular globally, with most millennials looking for suitable connections and partners on such platforms. However, due to the increased volumes, the dating app market has become congested with unexciting and monotonous platforms. With the challenge of creating a unique and convenient app for users of all age groups, we conceptualized a platform that makes the process of finding soul mates easier and more fulfilling.
								</p>						
							</div>
						</div>
					</div>
				...
				<div class="col-md-7 col-lg-7 col-sm-12 margin-b-3">
					<div class="challenge-card">
						<div class="challenge-img">
							<img class="fix-img" src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/amour/glowapp-project-highlights.webp" alt="challenge-new" width="640" height="320" loading="lazy"/>
						</div>
						<div class="challenge-left">
							<div class="challenge-left-heading ">
							...
							<div class="challenge-content">
								<ul>
									<li><div class="flex-disp"><i class="fa fa-angle-double-right"></i> <p>Chatting </p></div></li>
									<li><div class="flex-disp"><i class="fa fa-angle-double-right"></i> <p>Discrete Meet </p></div></li>
									<li><div class="flex-disp"><i class="fa fa-angle-double-right"></i><p>Love Lounge</p></div></li>
									<li><div class="flex-disp"><i class="fa fa-angle-double-right"></i><p>Advanced Match Making Algorithm</p></div></li>
									<li><div class="flex-disp"><i class="fa fa-angle-double-right"></i><p>Subscription/Membership Plans</p></div></li>
			...
			<div class="inner-insights theme-bg padding-3">
				<div class="row">
					...
					<div class="col-md-12 col-lg-12">
						...
						<p>One of the most thoughtfully designed and developed dating Apps for people who wish to find real-life partners. Unlike most available options, the developed app has a host of unique features that make match-making quick and effortless for every user. People can quickly register themselves and add their preferences through intuitive questionnaires. Next, they can search for people based on Heart Ratings, and they would match if they share similar interests. Matched users can then chat and find out if they are perfect for each other.</p>
						<p>What truly sets this app apart is its unique modules like Love Lounge and Discrete Meet.</p>
						<p>1. In the love lounge, users can join and discuss the topics (Based on the location). Users can select any lounge and chat with each other. Also, they can tap on any profile and send messages directly.</p>	
						<p>2. In the discrete meet, users can see 5 random users based on their preference and send a Heart or Broken Heart on the profile. When both react, they can directly chat with each other.</p>				
					</div>
				</div>
			</div>
		</div>
				...
				<div class="row">
					...
					<div class="col-xs-6 col-sm-4 col-md-3 col-lg-3">
						<div class="screens-img">
							<img src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/amour/screens-01.webp" alt="screens-01" width="640" height="320" loading="lazy">
						</div>
					</div>
					<!-- Item -->
					<div class="col-xs-6 col-sm-4 col-md-3 col-lg-3">
						<div class="screens-img">
							<img src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/amour/screens-02.webp" alt="screens-02" width="640" height="320" loading="lazy">
						</div>
					</div>
					<!-- Item -->
					<div class="col-xs-6 col-sm-4 col-md-3 col-lg-3">
						<div class="screens-img">
							<img src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/amour/screens-03.webp" alt="screens-03" width="640" height="320" loading="lazy">
						</div>
					</div>
					<!-- Item -->
					<div class="col-xs-6 col-sm-4 col-md-3 col-lg-3">
						<div class="screens-img">
							<img src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/amour/screens-04.webp" alt="screens-04" width="640" height="320" loading="lazy">
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			...
			<div class="subject-matter">
				<div class="">
					...
					<p class="content">
						Sanjeev Verma has been actively conceptualizing and creating software solutions for the past 20 years in the IT domain. He has worked on technical leadership positions with Marriott Vacations, Disney, MasterCard, Statefarm, and Oracle.
			...
			<div class="container">
				...
				<div class="row flex-disp flex-align-center flex-wrap">
					<div class="col-md-6 col-xs-12 padding-0 col-sm-12">
						<img src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/subsciety-business-benefits.webp" alt="business-benefits" width="640" height="320" loading="lazy"/>
					</div>
								...
								<ul>	
									<li>
										<div class="flex-disp">
											...
											<p class="content">
												The total user count grew by 65% just within a couple of weeks of the app launch. 
											</p>
										</div>
									</li>
									<li>
										<div class="flex-disp">
											<i class="fa fa-angle-double-right"></i> 
											<p class="content">
												Statistics show that the ratio of premium subscribers to freemium subscribers is nearly the same resulting in higher ROI
											</p>
										</div>
									</li>
									<li>
										<div class="flex-disp">
											<i class="fa fa-angle-double-right"></i> 
											<p class="content">
												Fantastic marketing opportunities helped the app to get ranked among the market leaders.
											</p>
										</div>
									</li>
									<li>
										<div class="flex-disp">
											<i class="fa fa-angle-double-right"></i> 
											<p class="content">
												Ranked among the most engaging dating apps on the app store
											</p>
										</div>
									</li>
									<li>
										<div class="flex-disp">
											<i class="fa fa-angle-double-right"></i> 
											<p class="content">
												The user base is growing at the rate of 19% week after week
										</div>
									</li>
								</ul>
							</div>
				...
				<div class="row flex-disp flex-align-center flex-wrap">
					<div class="col-md-6 padding-0">
						<img src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/amour/trustedadviser.webp" alt="trustedadviser" width="640" height="320" loading="lazy"/>
					</div>
					<div class="col-md-6 col-xs-12 col-sm-12">
						<div class="challenge-left">
							<div class="challenge-left-heading ">
				...
				<div class="row flex-disp flex-align-center flex-wrap">
					...
					<div class="col-md-6 col-xs-12 padding-0 col-sm-12">
						<img src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/amour/suggestion.webp" alt="suggestion" width="640" height="320" loading="lazy"/>
					</div>
				</div>
			</div>
		</div>
			...
			<h2 class="heading-section margin-b-3 text-center">Tech Stack</h2>
				<div class="owl-carousel owl-theme owl-demo2">
					...
					<div class="item">
						<div class="tech-stack margin-b-3">
							<div class="tech-box">
								<img src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/mern.webp" alt="mern" width="640" height="320" loading="lazy">
							</div>
							<h3 class="horizontal-line bg-glow-app">MERN with MongoDB</h3>
							<p>
	...
	<!--teck-stack-ends-->
     <img class="w-100" src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/amour/demo-banner.webp" alt="demo-banner" width="640" height="320" loading="lazy"/>
	<!--similar-projects-->
	<section>
		<div class="container">
