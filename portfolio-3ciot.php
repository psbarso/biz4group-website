...
<link rel="stylesheet" href="css/portfolionew.css" media>
<link rel="preconnect" href="https://fonts.googleapis.com" media>
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin media>
<link href="https://fonts.googleapis.com/css2?family=Livvic:wght@100;200;300;400;500;600;700;900&display=swap" rel="stylesheet" media>
<style>
	...
	background: transparent linear-gradient(180deg, #1e2739 0%, #5670a3 100%) 0% 0% no-repeat padding-box;
	 }
	.theme-border{
	...
	.portfolio-banner{
	background-image: url("https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/3ciot/glowapp-banner-new.webp");
	}
	.testomonial-outer{
	border: 10px solid #1e2739;}	
...
<div class="app-portfolio-page">
	 ...
	 <img src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/3ciot/glow-hero.webp" alt="glow-hero"
	 ...
	 <div class="col-md-4 col-sm-12 center-al">
		...
		<h2>Dam Water Management<br/> Automation using IoT</h2>
	 </div>
	 </div>
	 </div>
		...
		<div class="container">
			...
			<h2 class="heading-section margin-b-3 text-center">Our Smart, Efficient & Productive Approach</h2>
				...
				<div class="col-md-5 col-lg-5 col-sm-12 margin-b-3">
					<div class="challenge-card">
						<div class="challenge-img">
							<img class="fix-img" src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/3ciot/glowapp-challenge-new.webp" alt="glowapp-challenge-new"
							loading="lazy" width="640" height="320"
							/>
						</div>
						<div class="challenge-left">
							...
							<div class="challenge-content">
								<p>Dams play a crucial role in storing and conserving water for optimum use, depending on seasonal requirements. This describes the importance of Water Management in resolving the present problems of water distribution and use. As water is one of the fundamental requirements for human living, periodic monitoring of water quality is essential. Therefore, it is necessary to provide filtered drinking water to both urban and rural populations.</p>			
								<p>Our IoT developer team managed to work on a project to monitor and regulate the water distribution management. It is possible through the use of different sensors, control valves, and the automated and proactive management of outflow during a crisis by using statistical data of the environment.</p>
							</div>
						</div>
					</div>
				</div>
				<div class="col-md-7 col-lg-7 col-sm-12 margin-b-3">
					<div class="challenge-card">
						<div class="challenge-img">
							<img class="fix-img" src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/3ciot/glowapp-project-highlights.webp" alt="glowapp-project-highlights"
							loading="lazy" width="640" height="320"
							/>
						</div>
						<div class="challenge-left">
							...
							<div class="challenge-content">
								<ul>
									<li><div class="flex-disp"><i class="fa fa-angle-double-right"></i> <p>Water Level Sensor</p></div></li>
									<li><div class="flex-disp"><i class="fa fa-angle-double-right"></i> <p>Real-Time Data Analysis and Updates</p></div></li>
									<li><div class="flex-disp"><i class="fa fa-angle-double-right"></i> <p>Location-based detection</p></div></li>
									<li><div class="flex-disp"><i class="fa fa-angle-double-right"></i> <p>Multiple sensor implementation on a single platform</p></div></li>
								</ul>
							</div>
						</div>
					</div>
			...
			<div class="inner-insights theme-bg padding-3">
				<div class="row">
					...
					<div class="col-md-12 col-lg-12">
						...
						<p>Biz4Group explores the use of IoT to improve dam utilization efficiency. The planned project comprises of a number of sensors for measuring different parameters. This includes pH value, turbidity in the water, water level in the tank, ambient temperature, and relative humidity. Traditionally, water quality analysis was accomplished manually through using water samples. Such approaches do not offer data in real-time. The suggested water quality monitoring platform is comprised of a microcontroller and sensors that are capable of notifying the current state of the dam. It alerts authorities as well when dam conditions deviate from normal.</p>		
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			...
			<div class="screens-inner">
				<div class="screens-web-img">
					<img src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/3ciot/design.webp" alt="design" 
					loading="lazy" width="640" height="320"
					/>
				</div>
			</div>
			...
			<div class="container">
				...
				<div class="row flex-disp flex-align-center flex-wrap">
					<div class="col-md-6 col-xs-12 padding-0 col-sm-12">
						<img src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/3ciot/subsciety-business-benefits.webp" alt="subsciety-business-benefits"
						loading="lazy" width="640" height="320"
						/>
					</div>
								...
								<ul>	
									<li>
										<div class="flex-disp">
											...
											<p class="content">Diagnose the water pumped, supplied and average LPCD in a particular area with just one go.</p>
										</div>
										<div class="flex-disp">
											<i class="fa fa-angle-double-right"></i> 
											<p class="content">Easy and convenient to track the dam water purity, water flow and activities of the pump station through water management software.</p>
										</div>
										<div class="flex-disp">
											<i class="fa fa-angle-double-right"></i> 
											<p class="content">Real time data analysis can fetch the current data of the Dam Water Management process, to take further decisions and plan strategies for improvement.    </p>
										</div>
										<div class="flex-disp">
											<i class="fa fa-angle-double-right"></i> 
											<p class="content">Minimize workforce efforts, therefore enhance productivity. </p>
										</div>
										<div class="flex-disp">
											<i class="fa fa-angle-double-right"></i> 
											<p class="content">Measure a variety of parameters in a convenient manner. </p>
										</div>										
									</li>
								</ul>
							</div>
				...
				<div class="row flex-disp flex-align-center flex-wrap">
					...
					<div class="col-md-6 col-xs-12 col-sm-12 padding-0">
						<img src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/technical-components.webp" alt="technical-components"
						loading="lazy" width="640" height="320"
						/>
					</div>
				</div>
				<div class="row flex-disp flex-align-center flex-wrap">
					<div class="col-md-6 padding-0">
						<img src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/3ciot/trustedadviser.webp" alt="trustedadviser"
						loading="lazy" width="640" height="320"
						/>
					</div>
					<div class="col-md-6 col-xs-12 col-sm-12">
				...
				<div class="row flex-disp flex-align-center flex-wrap">
					...
					<div class="col-md-6 col-xs-12 padding-0 col-sm-12">
						<img src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/3ciot/suggestion.webp" alt="suggestion"
						loading="lazy" width="640" height="320"
						/>
					</div>
				</div>
      ...
      <div id="owl-demo2" class="owl-carousel owl-theme">
        <div class="item">
          <div class="tech-stack margin-b-3">
            <div class="tech-box">
            	<img src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/ReactJS.webp" alt="ReactJS"
            	loading="lazy" width="640" height="320"
            	 />
            </div>
            ...
            <p>
              ...
              building user interfaces or UI components. It allows developers to
              reuse the components built for the same functionality, reducing
              the development effort and ensuring flawless performance.
            </p>
          </div>
        </div>
        <div class="item">
          <div class="tech-stack margin-b-3">
            ...
            <p>
              Node.js is based on Google’s V8 JavaScript engine that compiles
              the code directly into the machine code, improving the speed and
              performance of the platform. In addition, it delivers better
              efficiency and overall developer productivity through code sharing
              and reusability.
            </p>
          </div>
        </div>
        <div class="item">
			<div class="tech-stack margin-b-3">
				<div class="tech-box">
					<img src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/MySQL.webp" alt="MySQL"
					loading="lazy" width="640" height="320"
					 />
				</div>
	...
	<div>
     	<img class="w-100" 
     		src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/3ciot/demo-banner.webp" alt="demo-banner"
     		loading="lazy" width="640" height="320"
     	/>
	</div>
	<!--similar-projects-->
