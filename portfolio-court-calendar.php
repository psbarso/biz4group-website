...
<style>
	...
	background: transparent linear-gradient(180deg, #3b4091 0%, #6467a3 100%) 0% 0% no-repeat padding-box;
	 }
	.theme-border{
	...
	.portfolio-banner{
	background-image: url("https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/court-calendar/glowapp-banner-new.webp");
	}
	.testomonial-outer{
	border: 10px solid #292e88;}	
...
<div class="app-portfolio-page">
	 ...
	 <img src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/court-calendar/glow-hero.webp" alt="glow-hero"
	 ...
	 <div class="col-md-4 col-sm-12 center-al">
		...
		<h2>Highly Utilitarian <br/>Judiciary Platform for <br/>Attorneys and Law Firms</h2>
	 </div>
	 </div>
	 </div>
		...
		<div class="container">
			...
			<h2 class="heading-section margin-b-3 text-center">OUR SMART, EFFICIENT & PRODUCTIVE APPROACH</h2>
				...
				<div class="col-md-5 col-lg-5 col-sm-12 margin-b-3">
					<div class="challenge-card">
						<div class="challenge-img">
							<img class="fix-img" src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/court-calendar/glowapp-challenge-new.webp" alt="challenge-new"
								loading="lazy" width="640" height="320"
							/>
						</div>
						<div class="challenge-left">
							...
							<div class="challenge-content">
								<p>The modern-day legal system struggles with a severe issue regarding the backlog of active and pending cases. Even with numerous courtrooms functioning extra shifts, the substantially higher workloads and increased processing times result in the piling up of cases, thus giving quite a hard time, not just to the judges but attorneys as well. With a successful collaboration with Biz4Group, the leading law firms in the States conceptualized an efficient judiciary platform for Attorneys & Surrogates. The platform necessarily simplifies the management of administrative functions for the Attorneys, including activities related to the case, facility, finances, or human resources.</p>						
							</div>
						</div>
					</div>
				</div>
				<div class="col-md-7 col-lg-7 col-sm-12 margin-b-3">
					<div class="challenge-card">
						<div class="challenge-img">
							<img class="fix-img" src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/court-calendar/glowapp-project-highlights.webp" alt="challenge-new"
								loading="lazy" width="640" height="320"
							/>
						</div>
						<div class="challenge-left">
							...
							<div class="challenge-content">
								<ul>
									<li><div class="flex-disp"><i class="fa fa-angle-double-right"></i> <p>Attorneys & Surrogates can access the system to know the status of their cases.</p></div></li>
									<li><div class="flex-disp"><i class="fa fa-angle-double-right"></i> <p>Attorneys & Surrogates can also schedule case hearing and manage workload.</p></div></li>
								</ul>
							</div>
						</div>
					</div>
			...
			<div class="inner-insights theme-bg padding-3">
				<div class="row">
					...
					<div class="col-md-12 col-lg-12">
						...
						<p>Developed a one-of-a-kind judiciary platform for US attorneys seeking an affiliated platform to search, manage, and schedule their court hearings for their active/ pending cases. Designed and developed by our team of experts, the platform serves as the vanguard for judicial branch support and as one of the three cornerstones of the state's representative democracy. It is backed by a non-profitable law organization to support court operations and improve access to justice for all.</p>
						<p>Attorneys can quickly get onboard and stay informed regarding the critical dates of court hearings and even schedule their slots in advance.</p>			
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			...
			<div class="screens-inner">
				<div class="screens-web-img">
					<img src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/court-calendar/design.webp" alt="design" 
						loading="lazy" width="640" height="320"
					/>
				</div>
			</div>
			...
			<div class="container">
				...
				<div class="row flex-disp flex-align-center flex-wrap">
					<div class="col-md-6 col-xs-12 padding-0 col-sm-12">
						<img src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/court-calendar/subsciety-business-benefits.webp" alt="subsciety-business-benefits" 
							loading="lazy" width="640" height="320"
						/>
					</div>
				...
				<div class="row flex-disp flex-align-center flex-wrap">
					<div class="col-md-6 padding-0">
						<img src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/court-calendar/trustedadviser.webp" alt="trustedadviser"	
							loading="lazy" width="640" height="320"
						/>
					</div>
					<div class="col-md-6 col-xs-12 col-sm-12">
				...
				<div class="row flex-disp flex-align-center flex-wrap">
					...
					<div class="col-md-6 col-xs-12 padding-0 col-sm-12">
						<img src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/court-calendar/suggestion.webp" alty="suggestion" 
							loading="lazy" width="640" height="320"
						/>
					</div>
				</div>
		...
		<div class="container">
			<h2 class="heading-section margin-b-3 text-center">Tech Stack</h2>
				<div id="owl-demo2" class="owl-carousel owl-theme">
					...
					<div class="item">
						<div class="tech-stack margin-b-3">
							<div class="tech-box"><img src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/php.webp" alt="php" 
								loading="lazy" width="640" height="320"
							/></div>
					...
					<div class="item">
						<div class="tech-stack margin-b-3">
								<div class="tech-box"><img src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/MySQL.webp" alt="MySQL" 
									loading="lazy" width="640" height="320"
								/></div>
	...
	<!--teck-stack-ends-->
     <img class="w-100" src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/court-calendar/demo-banner.webp" alt="demo-banner" 
	 loading="lazy" width="640" height="320"
	 />
	<!--similar-projects-->
	<section>
