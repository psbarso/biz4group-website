			...
			<div class="container">
				<div class="row flex-disp flex-align-center flex-wrap flex-justify-center">
					<div class="col-md-8 col-sm-12  alt-order">
						<img src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/boat-butler/glow-hero.webp" alt="glow-hero"
		...
		<div class="container">
			...
			<h2 class="heading-section margin-b-3 text-center">Our Smart, Efficient & Productive Approach</h2>
				...
				<div class="col-md-5 col-lg-5 col-sm-12 margin-b-3">
					<div class="challenge-card">
						<div class="challenge-img">
							<img class="fix-img" src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/boat-butler/glowapp-challenge-new.webp" alt="challenge-new"
							loading="lazy" width="640" height="320"/>
						</div>
				...
				<div class="col-md-7 col-lg-7 col-sm-12 margin-b-3">
					<div class="challenge-card">
						<div class="challenge-img">
							<img class="fix-img" src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/boat-butler/glowapp-project-highlights.webp" 
				...
				<div class="row">
					...
					<div class="col-xs-6 col-sm-4 col-md-3 col-lg-3">
						<div class="screens-img">
							<img src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/boat-butler/screens-01.webp" alt="screens-01" 
							loading="lazy" width="640" height="320"/>
						</div>
					</div>
					<!-- Item -->
					<div class="col-xs-6 col-sm-4 col-md-3 col-lg-3">
						<div class="screens-img">
							<img src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/boat-butler/screens-02.webp" alt="screens-02" 
							loading="lazy" width="640" height="320"/>
						</div>
					</div>
					<!-- Item -->
					<div class="col-xs-6 col-sm-4 col-md-3 col-lg-3">
						<div class="screens-img">
							<img src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/boat-butler/screens-03.webp" alt="screens-03" 
							loading="lazy" width="640" height="320"/>
						</div>
					</div>
					<!-- Item -->
					<div class="col-xs-6 col-sm-4 col-md-3 col-lg-3">
						<div class="screens-img">
							<img src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/boat-butler/screens-04.webp" alt="screens-04" 
							loading="lazy" width="640" height="320"/>
						</div>
					</div>
				</div>
				...
				<div id="owl-demo2" class="owl-carousel owl-theme">
					<div class="item">
						<div class="tech-stack margin-b-3">
							<div class="tech-box">
								<img src="https://d1fxfakb0fcon3.cloudfront.net/images/portfolio/ionic.webp" alt="ionic"
								loading="lazy" width="640" height="320"
								/>
							</div>
