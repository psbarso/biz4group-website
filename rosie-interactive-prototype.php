	...
	<div class="container">
		<div class="row">
			...
			<div class="interactive-prototype-detail-content">
					<h5>Dashboard To Help Specific Users Control Key Functions In A Production Plant</h5>
					<p>The developed dashboard will help different user groups to control the robots giving them the direct access to their individual key functions. A dashboard can  have a number of widgets each representing a feature in the system.</p>
			  ...
			  <div class="ip-desktop-img" id="ip-click-demo">
					<img src="images/rosie-inner.png" alt="">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content abt-content">
      ...
      <div class="modal-body">
		<div class="">
		<iframe width="100%" src="https://xd.adobe.com/embed/a9e1c26a-661e-4aa9-93d9-86a5bdf76317-fcb2/" frameborder="0" allowfullscreen></iframe>
		</div>
		<h5>Dashboard To Help Specific Users Control Key Functions In A Production Plant</h5>
		<p>The developed dashboard will help different user groups to control the robots giving them the direct access to their individual key functions. A dashboard can  have a number of widgets each representing a feature in the system.</p>
		</div>
