	...
	<div class="container">
		<div class="row">
			...
			<div class="interactive-prototype-detail-content">
					<h5>A Platform giving a glimpse of covid 19 scenarios</h5>
					<p>An online web platform that tracks the live census of people affected by a disease at large such as the COVID-19.</p>
			  ...
			  <div class="ip-desktop-img" id="ip-click-demo">
					<img src="images/rdeex-desktop-img.png" alt="">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content abt-content">
      ...
      <div class="modal-body">
		<div class="">
		<iframe width="100%" src="https://xd.adobe.com/embed/04e825e0-53c6-4197-65d7-5799af5ab711-72d9/" frameborder="0" allowfullscreen></iframe>
		</div>
		<h5>A Platform giving a glimpse of covid 19 scenarios</h5>
	<p>An online web platform that tracks the live census of people affected by a disease at large such as the COVID-19.</p>
	</div>
