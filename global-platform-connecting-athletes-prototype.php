	...
	<div class="container">
		<div class="row">
			...
			<div class="interactive-prototype-detail-content">
					<h5>eCommerce solutions to connect athletes globally</h5>
					<!--<p>A platform for athletes, where they can showcase their profile along with their merchandise by signing up on the website and buyers can not only sign them on a contractual basis but interested fans can also buy their favorite athlete's merchandise as well. </p>-->
					<p>With sports getting advances throughout the globe, athletes are becoming real stars. Racooda serves as a platform for athletes, where they can showcase their profile along with their merchandise by signing up on the website and buyers and fans can purchase their favorite athlete's merchandise. This website also enables buyers to view athletes’ profile without signing up or signing in.</p>
			  ...
			  <div class="ip-desktop-img" id="ip-click-demo">
					<img src="images/racooda-desktop-img.png" alt="">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content abt-content">
      ...
      <div class="modal-body">
		<div class="">
		<iframe width="100%" src="https://xd.adobe.com/embed/c220925a-0455-406b-42f7-7090cb362853-b411/" frameborder="0" allowfullscreen></iframe>
		</div>
		<h5>eCommerce solutions to connect athletes globally</h5>
		<p>A platform for athletes, where they can showcase their profile along with their merchandise by signing up on the website and buyers can not only sign them on a contractual basis but interested fans can also buy their favorite athlete's merchandise as well. </p>
		</div>
