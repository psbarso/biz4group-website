	...
	<div class="container">
		<div class="row">
			...
			<div class="interactive-prototype-detail-content">
					<h5>Unique Platform For Users To Get Their Bucket List Turned Into Reality</h5>
					<p>The subscription-based platform allows users to create a bucket list of maximum 5 things they would like to have or achieve before they die. The team would then try to turn one or more of those items into reality for them while all of it will be shown on their upcoming show “YouBucket” depending on user’s will. Users can also change or edit their bucket lists and change their billing information from their profiles.</p>
			  ...
			  <div class="ip-desktop-img" id="ip-click-demo">
					<img src="images/youbucket-inner.png" alt="">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content abt-content">
      ...
      <div class="modal-body">
		<div class="">
		<iframe width="100%" src="https://xd.adobe.com/embed/dbfe299d-c0a7-407b-9f3d-c85fe03e070a-8ead/" frameborder="0" allowfullscreen></iframe>
		</div>
		<h5>Unique Platform For Users To Get Their Bucket List Turned Into Reality</h5>
		<p>The subscription-based platform allows users to create a bucket list of maximum 5 things they would like to have or achieve before they die. The team would then try to turn one or more of those items into reality for them while all of it will be shown on their upcoming show “YouBucket” depending on user’s will. Users can also change or edit their bucket lists and change their billing information from their profiles.</p>
		</div>
