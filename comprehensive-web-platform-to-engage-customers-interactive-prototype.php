<?php include_once("header.php");
	...
	<div class="container">
		<div class="row">
			...
			<div class="interactive-prototype-detail-content">
					<h5>Comprehensive Web Platform to Engage customers</h5>
					<p>It ensures delivering service-related customizable message templates & time-sensitive notifications. It is for real-time communication with end customers.</p>
			  ...
			  <div class="ip-desktop-img" id="ip-click-demo">
					<img src="images/peak-desktop-img.png" alt="">
 ...
 <div class="detail-listing-prototype">
	<div class="container-fluid">
		...
		<a href="https://www.biz4group.com/interactive-prototype">View All</a>
		</div>
	</div>
 </div>
