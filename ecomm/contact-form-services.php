<?php 
 ...
 require_once 'validateCaptcha1.php';
 ...
 if(filter_has_var(INPUT_POST, 'submit1')){
  ...
  if( $status==0){
   ...
   $sir_name = htmlspecialchars($_POST['name2']);
    ...
    if(filter_var($email,FILTER_VALIDATE_EMAIL) === false){
      ...
      <table width="600" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #E3E3E3;" align="center">
        ...
        <tr>
          ...
          <td align="left" valign="top" style="font-family: Arial, Helvetica, sans-serif; font-size:13px;  color:#3e3e3e; background-color:#f7f7f7;">'.$name." ".$sir_name.'</td>
        </tr>
        <tr>
...
// More headers
          ...
          if($mail->sendMail($to,$subject,$body,$headers)){
			...
			header('location:https://www.biz4group.com/thankyou.php');
