	...
	<div class="container">
		<div class="row">
			...
			<div class="interactive-prototype-detail-content">
					<h5>Interactive Online Learning Platform For Students And Parents</h5>
					<p>Homeroom is a platform for students/ parents to enroll and search for teachers on the basis of subject, location, or online reviews. The system enables the students/ parents to schedule for a class, ask the query, and pay for that through the app. </p>
			  ...
			  <div class="ip-desktop-img" id="ip-click-demo">
					<img src="images/home-room-inner.png" alt="">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content abt-content">
      ...
      <div class="modal-body">
		<div class="">
		<iframe width="100%" src="https://xd.adobe.com/embed/e935cef1-3f49-463f-97c9-be626af9dd86-bc66/" frameborder="0" allowfullscreen></iframe>
		</div>
		<h5>Interactive Online Learning Platform For Students And Parents</h5>
		<p>Homeroom is a platform for students/ parents to enroll and search for teachers on the basis of subject, location, or online reviews. The system enables the students/ parents to schedule for a class, ask the query, and pay for that through the app. </p>
		</div>
