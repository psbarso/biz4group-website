	...
	<div class="container">
		<div class="row">
			...
			<div class="interactive-prototype-detail-content">
					<h5>Communication Platform For Players And Coaches</h5>
					<p>Sportal acts as a useful bridge between coaches and team players wherein the coaches can easily connect with their respective team players and manage their activities and events from a single platform.</p>
			  ...
			  <div class="ip-desktop-img" id="ip-click-demo">
					<img src="images/interactive-prototype-sportal-2.png" alt="">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content abt-content">
      ...
      <div class="modal-body">
		<div class="">
		<iframe width="100%" src="https://xd.adobe.com/embed/dec4cb84-ba25-4502-bce7-bcced8ba488d-8b97/" frameborder="0" allowfullscreen></iframe>
		</div>
		<h5>Communication Platform For Players And Coaches</h5>
		<p>Sportal acts as a useful bridge between coaches and team players wherein the coaches can easily connect with their respective team players and manage their activities and events from a single platform.</p>
		</div>
