	...
	<div class="container">
		<div class="row">
			...
			<div class="interactive-prototype-detail-content">
					<h5>Utility Dashboard To Help Manage Business Specific Tasks And Functions</h5>
					<p>Developed a dashboard to show daily testing status along with their failure counts, as well as the task history based on date filter.</p>
			  ...
			  <div class="ip-desktop-img" id="ip-click-demo">
					<img src="images/emi-dashboard-inner.png" alt="">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content abt-content">
      ...
      <div class="modal-body">
		<div class="">
		<iframe width="100%" src="https://xd.adobe.com/embed/4d3eaa28-1e9b-4f32-8bdb-fbc34c5f3e83-186d/" frameborder="0" allowfullscreen></iframe>
		</div>
		<h5>Utility Dashboard To Help Manage Business Specific Tasks And Functions</h5>
		<p>Developed a dashboard to show daily testing status along with their failure counts, as well as the task history based on date filter.</p>
		</div>
