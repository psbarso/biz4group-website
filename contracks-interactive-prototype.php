	...
	<div class="container">
		<div class="row">
			...
			<div class="interactive-prototype-detail-content">
					<h5>A Unique Platform For Managing Real Estate Contracts.</h5>
					<p>Contracks on the web was designed to help in managing all the information connected to real estate contracts and to provide notifications for crucial dates and events. By setting on personalised notifications and alerts, users may also keep track of what has been completed and what remains in terms of contract formalities.</p>
			  ...
			  <div class="ip-desktop-img" id="ip-click-demo">
					<img src="images/interactive-prototype-contracks-web.png" alt="">
...
<!-- Modal -->
<div id="prototype-modal1" class="modal fade ip-pop-up" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content abt-content">
      ...
      <div class="modal-body">
		<div class="">
		<iframe width="100%" src="https://xd.adobe.com/embed/224ed479-06a2-4b64-90b1-159844760b4a-771d/" frameborder="0" allowfullscreen></iframe>
		</div>
		<h5>A Unique Platform For Managing Real Estate Contracts.</h5>
		<p>Contracks web and mobile apps are designed to help manage all the property contract-related information and also provide notifications to track the important events/dates related to a specific contract. Users can also check on what has been done in the contract formalities and what is left by turning on custom notifications and alerts.</p>
		</div>
    </div>
  </div>
</div>
