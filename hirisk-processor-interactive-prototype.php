	...
	<div class="container">
		<div class="row">
			...
			<div class="interactive-prototype-detail-content">
					<h5>Unique Solution To Facilitate Business Functionalities</h5>
					<p>A comprehensive solution to provide Hi Risk Merchants with stable long-term solutions incorporating technological solutions for 21st century challenges while keeping their clients’ interests in mind and understating their business through a consultative approach.</p>
			  ...
			  <div class="ip-desktop-img" id="ip-click-demo">
					<img src="images/hirisk-processor-inner.png" alt="">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content abt-content">
      ...
      <div class="modal-body">
		<div class="">
		<iframe width="100%" src="https://xd.adobe.com/embed/02cb4a0e-0226-4369-8e45-7a96fca5178e-5798/" frameborder="0" allowfullscreen></iframe>
		</div>
		<h5>Unique Solution To Facilitate Business Functionalities</h5>
		<p>A comprehensive solution to provide Hi Risk Merchants with stable long-term solutions incorporating technological solutions for 21st century challenges while keeping their clients’ interests in mind and understating their business through a consultative approach.</p>
		</div>
