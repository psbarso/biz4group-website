	...
	<div class="container">
		<div class="row">
			...
			<div class="interactive-prototype-detail-content">
					<h5>Collaborative Platform For Women Entrepreneurs</h5>
					<p>A platform to help women entrepreneurs share their business/ startup ideas and work upon skill development and constant learning. The idea is to create a community where founders can grow together as mentors or mentees.</p>
			  ...
			  <div class="ip-desktop-img" id="ip-click-demo">
					<img src="images/founder-fm-inner.png" alt="">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content abt-content">
      ...
      <div class="modal-body">
		<div class="">
		<iframe width="100%" src="https://xd.adobe.com/embed/2cb53e0f-7138-48ce-a960-6367b82d8c3e-79e6/" frameborder="0" allowfullscreen></iframe>
		</div>
		<h5>Collaborative Platform For Women Entrepreneurs</h5>
		<p>A platform to help women entrepreneurs share their business/ startup ideas and work upon skill development and constant learning. The idea is to create a community where founders can grow together as mentors or mentees.</p>
		</div>
