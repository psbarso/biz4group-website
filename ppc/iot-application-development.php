...
<head>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
		...
		<meta name="Title" content="IoT Application Development" />
		...
		<meta property="og:title" content="IoT Application Development"/>
		...
		<meta name="twitter:title" content="IoT Application Development"/>
		...
		<!--<link rel="stylesheet" href="<?php echo SITE_URL;?>css/style.css?ver=1" media="all">-->
		
		<link rel="preload" href="<?php echo SITE_URL;?>css/bootstrap.min.css" as="style" onload="this.onload=null;this.rel='stylesheet'">
		<noscript><link rel="stylesheet" href="<?php echo SITE_URL;?>css/bootstrap.min.css?ver=2" media="all"></noscript>
		
		<link rel="preload" href="<?php echo SITE_URL;?>css/iot-application-development.css?ver=5" as="style" onload="this.onload=null;this.rel='stylesheet'">
		<noscript><link rel="stylesheet" href="<?php echo SITE_URL;?>css/iot-application-development.css?ver=5" media="all"></noscript>
...
<script  type="text/javascript">
	...
	var onloadCallback_ppc = function(){
		...
		if ($('#captcha2_ppc').length > 0) {
		 ...
		 <!--<script rel="preload" src="https://www.google.com/recaptcha/api.js?onload=onloadCallback_ppc"></script>-->
			...
			<div class="row">
				<div class="col-md-2 col-sm-3 col-xs-3">
					<div class="header-logo">
						<a href="javascript:;"><img src="<?php echo SITE_URL;?>images/logo-new.png" alt=""></a>
					</div>
				</div>
...
<!--main start-->
 ...
 <div class="home-layout3" style="background-image:url(../images/home2-bg.jpg);">
	<div class="container">
		<div class="home-layout3-content">
			<div class="row">
				<div class="col-md-6 col-sm-6">
					<div class="home-layout3-banner">
						<h1>Creating Custom Built IoT Products and Applications for All Needs </h1>
						<p>A top rated IoT company indulged in providing custom product and application development services.</p>
						<a href="javascript:;" class="layout-theme-btn pulse" data-toggle="modal" data-target="#myModal">Let’s Connect</a>
					</div>
				</div>
				<div class="col-md-6 col-sm-6">
					<div class="home-layout3-banner-m wow fadeInLeft">
						<img src="../images/home-img-landing.png" alt="">
					</div>
				</div>
			</div>
		</div>
...
<div class="develop-technology">
   <div class="container">
      <div class="text-center">
         <h2 class="home-layout-heading-title">IoT Application and Custom Product Development Services</h2>
      </div>
      <div class="row">
         <div class="col-md-4 col-sm-6">
            <div class="develop-technology-box">
               <h2>Custom IoT Platform Development</h2>
               <p>We create personalized IoT products that are tailored as per your specific needs. These custom products make it easier for you to supervise your operations and take smart action to achieve business goals.</p>
            </div>
         </div>
         <div class="col-md-4 col-sm-6">
            <div class="develop-technology-box">
               <h2>IoT Development Consultancy</h2>
               <p>Our consultancy services will help you identify the features your business really requires and decide the aesthetics of the platform as per the operations that occur in your enterprise.</p>
            </div>
         </div>
         <div class="col-md-4 col-sm-6">
            <div class="develop-technology-box">
               <h2>IoT Application Development</h2>
               <p>Leverage services of Biz4Group in IoT application development to extend the capabilities of IoT solutions and smartly manage the processes of your enterprise from a smartphone.</p>
            </div>
         </div>
         <div class="col-md-4 col-sm-6">
            <div class="develop-technology-box">
               <h2>IoT Software Architecture</h2>
               <p>The software developed at Biz4Group supports and works on all layers of IoT technology that allow you to integrate all kinds of sensors and data engines to collect useful data.</p>
            </div>
         </div>
         <div class="col-md-4 col-sm-6">
            <div class="develop-technology-box">
               <h2>Backend Panel & API Integration</h2>
               <p>Use backend panels develop at Biz4Group to track and control your company’s operations like administration, supply chain, and on-floor activities as an admin. Leverage the features of integrated APIs to boost the functionality of your IoT platform even further.</p>
            </div>
         </div>
		 <div class="col-md-4 col-sm-6">
            <div class="develop-technology-box">
               <h2>IoT Implementation & Support</h2>
               <p>We help you to seamlessly implement IoT solutions and provide you 24*7 support along with a user manual to help you understand and comprehend the full capabilities of the IoT platform.</p>
            </div>
         </div>
      </div>
   </div>
...
<div class="services-offered">
	<div class="container">
		<div class="text-center">
         <h2 class="home-layout-heading-title" style="display: inline;">Biz4Group Presents an In-house Developed Multi-Million Dollar IoT Product </h2>
         <!--<p class="home-layout-heading-pera" style="margin-top:10px;">Product Features</p>-->
		</div>
		...
		<div class="services-offered-tab">
			<div class="row">
				<div class="col-md-4">
					<ul class="nav">
				    	<li class="active"><a data-toggle="tab" href="#menu1">Detailed Reports</a></li>
				    	<li><a data-toggle="tab" href="#menu2">Get Instant Alerts</a></li>
				    	<li><a data-toggle="tab" href="#menu3">Data Analytics</a></li>
				    	<li><a data-toggle="tab" href="#menu4">Real-time monitoring</a></li>
				    	<li><a data-toggle="tab" href="#menu5">Customizable Platform</a></li>
				  	</ul>
				</div>
				<div class="col-md-8">
					<div class="tab-content">
					    <div id="menu1" class="tab-pane fade in active">
					    	<div class="services-offered-tab-head">
					    		<img src="../images/detailed-reports.png">
					    		<h2>Detailed Reports</h2>
					    	</div>
					      <p>The comprehensive IoT product can seamlessly compile data and convert them into detailed reports in CSV, XLS, and PDF format. The data from these reports can also be processed into graphs and charts for easy visualization and insight generation.</p>
					    </div>
					    <div id="menu2" class="tab-pane fade">
					    	<div class="services-offered-tab-head">
					    		<img src="../images/get-instant-alerts.png">
					    		<h2>Get Instant Alerts</h2>
					    	</div>
					      <p>Based on the values of pre-defined threshold and tolerance values, alerts can be obtained on multiple channels like web applications and mobile app. The alerts can be gained in the form of push notifications, in-app messages, SMS, and emails.</p>
					    </div>
					    <div id="menu3" class="tab-pane fade">
					      ...
					      <p>Process data gathered from endpoints via advanced analytics and processing tools to develop useful insights. These insights can then be used to boost the life expectancy of equipment, mitigate inefficiencies in the supply chain, improve decision-making processes, and many more.</p>
					    </div>
					    <div id="menu4" class="tab-pane fade">
					    	<div class="services-offered-tab-head">
					    		<img src="../images/real-time-monitoring.png">
					    		<h2>Real-time monitoring</h2>
					    	</div>
					      <p>Keep an eye on your company’s processes effectively from any remote location with real-time monitoring features of our IoT platform. Get live readings from your equipment and assets; and manage all your processes effectively from anywhere in the world.</p>
					    </div>
					    <div id="menu5" class="tab-pane fade">
					    	<div class="services-offered-tab-head">
					    		<img src="../images/customizable-platform.png">
					    		<h2>Customizable Platform</h2>
					    	</div>
					      <p>All communication protocols and standards are supported by the platform making it flexible for infinite customization for any specific requirement. Hence, both black-box and white-box solutions can be provided for instant deployment and gradual system build-up respectively.</p>
					    </div>
				  	</div>
				</div>
			</div>	
			...
			<div class="row">
				<div class="col-md-12">
					<div class="client-partner-slider2 owl-carousel owl-theme wow fadeInLeft">
						...
						<div class="item">
							<a href="javascript:;" class="ranking-batch-link" target="_blank">
...
<div class="services-why-biz4group wow fadeInDown">
	<div class="container">
		<div class="text-center">
			<h2 class="home-layout-heading-title">Why Choose Biz4Group?</h2>
		</div>
		<div class="row">
			...
			<div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="0.4s">
				<div class="business-highlights-detail business-highlights-box">
					<div class="box-border"></div>
					<h4>Long-Standing Partnerships</h4>
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" style="background-image:url(<?php echo SITE_URL;?>images/clutch-bg-landing.jpeg);">
...
<script rel="preload" src="<?php echo SITE_URL;?>js/jquery.min.js"></script>
<script rel="preload" src="<?php echo SITE_URL;?>js/bootstrap.min.js"></script>

<script rel="preload" src="<?php echo SITE_URL;?>js/owl.carousel.min.js"></script>
<script>
		//home3-about-img
...
<script>
	$(document).ready(function() {
   setTimeout(function() {$.getScript("https://www.google.com/recaptcha/api.js?onload=onloadCallback_ppc");}, 2000);
	});
</script>
