...
<style>
	...
	.portfolio-banner{
	background-image: url("images/portfolio/MyShift/shiftfit-banner-new.png");
	}
	.testomonial-outer{
...
<div class="app-portfolio-page">
	 ...
	 <img src="images/portfolio/MyShift/shiftfit-bannerimg.png"/>
	 
	 </div>
	 <div class="col-md-4 col-sm-12 center-al">
	 <h1 class="horizontal-line bg-white banner"><b>PORTFOLIO</b></h1>
	<h2>A unique Platform for Work providers to find Workforce members and vice versa.</h2>
	 </div>
	 </div>
	 </div>
	...
	<section class="challenge-section">
		<div class="container">
			...
			<h2 class="heading-section margin-b-3 text-center">OUR SMART, EFFICIENT & PRODUCTIVE APPROACH</h2>
				...
				<img class="fix-img" src="images/portfolio/MyShift/shiftfit-challenge-new.png" alt="challenge-new"/>
				</div>
...
<p>The current job market today is flooded with a more <strong> competitive-than-normal pool of job seekers.</strong> These aspirants often face the issue of <strong> finding the right job </strong> due to multiple reasons such as <strong>lack of expertise, employment gap, no professional references, or referrals.</strong> There needs to be a <strong> broad-gauged job platform</strong> that not only helps <strong> connect job seekers and providers </strong> but also helps<strong> bridge the requirement gap.</strong> The proposed platform <strong> perfectly resolves the current issues in the hiring process</strong> for job providers as well as applicants.   </p>			</div>
					</div>
				</div>
				...
				<div class="challenge-card">
				<div class="challenge-img">
				<img class="fix-img" src="images/portfolio/MyShift/shiftfit-project-highlights.png" alt="challenge-new"/>
				</div>
					<div class="challenge-left">
						<div class="challenge-left-heading ">
						...
						<div class="challenge-content">
<ul>
									<li><div class="flex-disp"><i class="fa fa-angle-double-right"></i> <p>Platform for company staff to <strong> facilitate the process on behalf of other users</strong> </p></div></li>
									<li><div class="flex-disp"><i class="fa fa-angle-double-right"></i> <p><strong>Easy Punch in and Punch-out </strong> for the workforce members to log their working hours</p></div></li>
									<li><div class="flex-disp"><i class="fa fa-angle-double-right"></i><p>Invite <strong> qualified Workforce</strong> members for a job role</p></div></li>
									<li><div class="flex-disp"><i class="fa fa-angle-double-right"></i><p><strong>Easy management </strong> of employment-related activities such as <strong> applications, earnings, pay rate, etc.</strong></p></div></li>
									<li><div class="flex-disp"><i class="fa fa-angle-double-right"></i><p><strong>Clear and smooth communication</strong></p></div></li>
...
<p>A phenomenal jobs platform that allows its pool of temporary workforce members to <strong> secure open positions </strong> posted by the Work Providers in their preferred area. Workforce members can view the job listing based on their <strong> preferences</strong> and <strong> applicable skill set </strong> and <strong> apply</strong> for a particular job. The job providers will then receive a list of applications where they can directly view the details of each applicant and <strong> initiate the hiring rounds.</strong> The company staff members can also <strong> post a job </strong> on behalf of other recruiters and hire workforce members for them.</p>		</div>
				</div>
	...
	<section class="section-screens">
		<div class="container">
			...
			<img src="images/portfolio/MyShift/screens-01.png" />
				</div>
			</div>
		</div>
	</section>
...
<section>
		...
		<div class="subject-matter">
			...
			<div><h4 class="theme-color horizontal-line bg-shiftfit">Sanjeev Verma</h4><p><b>Exp: 20+ Years</b></p></div>
			</div>
...
He has been a key player in developing, implementing, and monitoring Digital Solutions ranging from IoT solutions &amp; products, Mobile and Web Development, and Digital Marketing to Full Stack Development and CMS solutions.
	...
	<div class="container">
		...
		<div class="challenge-left">
						...
						<div class="challenge-content">
<ul>
									<li><div class="flex-disp"><i class="fa fa-angle-double-right"></i> <p class="content">Broader reach to the pool of job seekers and applicants</p></div></li>
									<li><div class="flex-disp"><i class="fa fa-angle-double-right"></i><p class="content">Resource-saving and cost cut down as 90% of the hiring process will be facilitated using the mobile or web app.</p></div></li>
									<li><div class="flex-disp"><i class="fa fa-angle-double-right"></i><p class="content">Allow work providers to fulfill immediate hirings for urgent tasks.</p></div></li>
									<li><div class="flex-disp"><i class="fa fa-angle-double-right"></i><p class="content">Employers can initiate private hirings without disclosing their firms</p></div></li>
									</ul>						</div>
					</div>
		</div>
...
<ul>
		...
		<img src="images/portfolio/Reusability.png"/>
		</div>
		<div class="col-md-6 col-xs-12 col-sm-12">
		<div class="challenge-left">
						<div class="challenge-left-heading ">
							
							<h3 class="theme-color horizontal-line bg-shiftfit">Reusability </h3>
						</div>
						
						<div class="challenge-content">
<ul>
									<li><div class="flex-disp"><i class="fa fa-angle-double-right"></i> <p class="content">Code reusability helps us develop a cost effective product creating a win-win situation in terms of timeline and total cost. </p></div></li>
									</ul>						</div>
					</div>
		</div>
		...
		<div class="challenge-left ">
						<div class="challenge-left-heading">
							...
							<h3 class="theme-color horizontal-line bg-shiftfit">Suggestions</h3>
						</div>
...
<ul>
		...
		<div class="col-md-6 col-xs-12 padding-0 col-sm-12">
		<img src="images/portfolio/suggestion.jpg"/>
		</div>
		</div>
...
<p>React is a free and open-source front-end JavaScript library for building user interfaces or UI components. It allows developers to reuse the components built for the same functionality, reducing the development effort and ensuring flawless performance.</p>	
	...
	<p>Unlike traditional database systems that offer data management through tables and rows, MongoDB allows data management fields with the help of NoSQL. Resulting in no lag while handling more massive datasets.</p>
						...
						<div class="item">
						<div class="tech-stack margin-b-3">
	<div class="tech-box"><img src="images/ionic.png"></div>
...
<!--	<div class="row">
	...
	<h3 class="horizontal-line bg-shiftfit" >ReactJS</h3>
	...
	<div id="owl-demo-portfolio" class="owl-carousel owl-theme">
						...
						<div class="item">
					<a href="https://www.biz4group.com/portfolio-desc-ycf" target="_blank">
						<img src="images/ycf-main.jpg">
