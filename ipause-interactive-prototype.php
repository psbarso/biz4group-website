	...
	<div class="container">
		<div class="row">
			...
			<div class="interactive-prototype-detail-content">
					<h5>Customized Mobile App for Meditation Box Booking</h5>
					<p>A Meditation app was designed with an idea of providing a peaceful short term stay to those who are in search of a place so that they can medidate to calm the inner self.</p>
			  ...
			  <div class="ip-desktop-img" id="ip-click-demo">
					<img src="images/ipause-desktop-img?ver=1.2.png" alt="">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content abt-content">
      ...
      <div class="modal-body">
		<div class="">
		<iframe width="100%" src="https://xd.adobe.com/embed/36b53338-e906-4a33-69b5-2cb741c3f80a-4084/" frameborder="0" allowfullscreen></iframe>
		</div>
		<h5>Customized Mobile App for Meditation Box Booking</h5>
		<p>A Meditation app was designed with an idea of providing a peaceful short term stay to those who are in search of a place so that they can medidate to calm the inner self.</p>
		</div>
