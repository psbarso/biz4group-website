	...
	<div class="container">
		<div class="row">
			...
			<div class="interactive-prototype-detail-content">
					<h5>Marketplace with traditional bartering system</h5>
					<p>A unique web application that extends eCommerce from just "buying stuff" to a complete place for barter trade with modern features like deal security and shipping.</p>
			  ...
			  <div class="ip-desktop-img" id="ip-click-demo">
					<img src="images/gotta-barter-desktop-img.png" alt="">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content abt-content">
      ...
      <div class="modal-body">
		<div class="">
		<iframe width="100%" src="https://xd.adobe.com/embed/d3b21721-5748-48ec-5103-8dd13e5600d1-a583/" frameborder="0" allowfullscreen></iframe>
		</div>
		<h5>Marketplace with traditional bartering system</h5>
		<p>A unique web application that extends eCommerce from just "buying stuff" to a complete place for barter trade with modern features like deal security and shipping.</p>
		</div>
